...
{
	local pkgs="libengine-pkcs11-openssl* krb5-pkinit libengine-pkcs11-openssl opensc libccid pcscd libp11-2 libpam-p11 libpam-pkcs11 pcsc-tools libnss3-tools dnsutils python3-tk"
        check_update="$1"
